...
local Toggle = Tabs.Main:AddToggle("Eggs_RollsValue", {Title = "Auto Rolls [Skip Animation]", Description = "- Automatics Rolls and Skip Animation", Default = false})
...
Tabs.Auto:AddSection("Automatics Features")
    ...
    local Toggle = Tabs.Auto:AddToggle("AutoFarmorbs", {Title = "Auto Farm Coins", Description = "- Automatics Farming Coin/Orbs", Default = false})
    ...
    local Toggle = Tabs.Auto:AddToggle("orbValue", {Title = "Auto Collects", Description = "- Automatics Collect Coins/Orbs/Fruits Etc. ", Default = false})
...
function startorbRollLoop()
    ...
    Tabs.Auto:AddSection("Relics Features")
...
function AutoPotionVendingMachineLoop()
    ...
    local Slider = Tabs.Shop:AddSlider("Slider", {
        Title = "Select Method Number Buy Potion Crafting",
    ...
    Tabs.Shop:AddSection("Index Merchant Features")

    local Toggle = Tabs.Shop:AddToggle("AutoBuyIndexMerchantValue", {Title = "Auto Buy Index Merchant", Default = false})
    Toggle:OnChanged(function(Value)
    _G.Index = Value
    if _G.Index then
         while _G.Index do wait()

            local args = {
                [1] = "AdvancedIndexMerchant",
                [2] = 1
            }
            ...
            game:GetService("ReplicatedStorage").Network.Merchant_RequestPurchase:InvokeServer(unpack(args)) local args = {
                [1] = "AdvancedIndexMerchant",
                [2] = 4
            }
    ...
    Tabs.Shop:AddSection("Fruit & Boosts")
    ...
    local MultiDropdown = Tabs.Shop:AddDropdown("MultiFruitDropdown", {
        Title = "Select Fruits",
    ...
    MultiDropdown:OnChanged(function(Value)
        ...
        for fruitName, state in next, Value do
            if state then
    ...
    Tabs.Shop:AddButton({
        ...
        Callback = function()
            ...
            for _, fruitName in ipairs(selectedFruits) do
                local fruitCode = fruits[fruitName] 
                if fruitCode then
                    local args = {
                        [1] = fruitCode,
                        [2] = amount
    ...
    local AutoUseFruit = Tabs.Shop:AddToggle("AutoUseFruitValue", {Title = "Auto Use Fruits", Default = false})
    AutoUseFruit:OnChanged(function(Value)
    _G.Index1 = Value
    if _G.Index1 then
         while _G.Index1 do wait()

            local args = {
               [1] = "0176f62846ba492fa14ad6ebb44fb0f5",
               [2] = 1
            }
            ...
            local args = {
                [1] = "5d1bac4b437440e1be4a65d7d316647d",
                [2] = 1
             }
             ...
             local args = {
               [1] = "620b1190c9894d44a285080967ab8935",
               [2] = 1
            }
            ...
            local args = {
                [1] = "152aea2631de45dca7f00e2115fd8b3e",
                [2] = 1
             }
             ...
             local args = {
                [1] = "b5812bbeddd5431d98ac7e2ba0bcd7e3",
                [2] = 1
             }
             ...
             local args = {
                [1] = "e66b62370a5a4a65bfe59f4b444c7c18",
                [2] = 1
             }
...
Tabs.Webhook:AddParagraph(
    {
        ...
        Content = "this very ez just copy discord webhook url and paste on here and enter you can get notify form Spectrum if you got something we got your Result Notification"
    }
)
...
local Toggle =
    ...
    {
        Title = "Send Webhook",
        Description = "Send Result Notification after you get some rare pet like 1/100,000,000 or Huge",
        Default = false
    }
)
