...
task.spawn(
    function()
        ...
        if game.PlaceId == 16146832113 then
            for I = 1, 6 do
                if game:GetService("Players").LocalPlayer.PlayerGui.HUD.Main.Units[tostring(I)]:FindFirstChild("Locked") or game:GetService("Players").LocalPlayer.PlayerGui.HUD.Main.Units[tostring(I)]:FindFirstChild("UnitTemplate") == nil then end
            ...
            for I = 1, 6 do
                if game:GetService("Players").LocalPlayer.PlayerGui.Hotbar.Main.Units[tostring(I)]:FindFirstChild("Locked") or game:GetService("Players").LocalPlayer.PlayerGui.Hotbar.Main.Units[tostring(I)]:FindFirstChild("UnitTemplate") == nil then end
...
if game.PlaceId == 16146832113 then
    ...
    task.spawn(
        function()
            for I = 1, 6 do
                if game:GetService("Players").LocalPlayer.PlayerGui.HUD.Main.Units[tostring(I)]:FindFirstChild("Locked") then end
    ...
    local function Check_Units(name)
        for I, V in next, OwnGui.Hotbar.Main.Units:GetChildren() do
            if V:IsA("Frame") then
                if V:FindFirstChild("Locked") or V:FindFirstChild("UnitTemplate") == nil then end
